...
<iframe
  src="docs/pdfs/labs/OAS3/Developing Native Server RESTful APIs for accesing Db2 REST Services.pdf"
  width="100%"
  height="600px"
  style="border:1px solid #ccc">
</iframe>

<a href="docs/pdfs/labs/OAS3/Developing Native Server RESTful APIs for accesing Db2 REST Services.pdf"
   target="_blank"
...
<a href="docs/pdfs/labs/OAS3/OpenAPI 3 development  for Db2 APIs CopyPaste .txt"
   target="_blank"
   class="ibm-btn ibm-btn-secondary">
  Preview txt file
</a>
